...
public class ScheduleExactAlarm extends CordovaPlugin {
    ...
    private static final String ACTION_REQUEST_SCHEDULE_EXACT_ALARM = "android.intent.action.REQUEST_SCHEDULE_EXACT_ALARM"; // Add this
...
if (ACTION_CHECK_PERMISSION.equals(action)) {
    ...
    private void requestPermissionAction(CallbackContext callbackContext, JSONArray permissions) throws Exception {
        if (permissions == null || permissions.length() == 0) {
            ...
            // Here, you can check for SCHEDULE_EXACT_ALARM permission
            val alarmManager = this.cordova.getActivity().getSystemService(Context.ALARM_SERVICE);
            if (alarmManager != null && alarmManager.canScheduleExactAlarms()) {
                ...
                this.cordova.getActivity().startActivityForResult(intent, REQUEST_CODE_ENABLE_PERMISSION);
            }
        }
    }
